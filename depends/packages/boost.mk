...
$(package)_config_libraries=chrono,filesystem,system,locale,regex,thread,test
...
define $(package)_build_cmds
  ICU_PATH=$(ICU_DIR) ./b2 link=static cxxflags=-fPIC -d2 -j2 -d1 --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) stage
endef

define $(package)_stage_cmds
  ICU_PATH=$(ICU_DIR) ./b2 link=static cxxflags=-fPIC -d0 -j4 --prefix=$($(package)_staging_prefix_dir) $($(package)_config_opts) install
endef
